 ...
 */
 ...
 public final class DirectiveConfig {
   // An empty directive config instance
    ...
    * @return true if directive has an alias, false otherwise.
    */
   public boolean hasAlias(final String directive) {
    ...
    */
   public String getAliasName(final String directive) {
     return aliases.get(directive);
   }
 
   /**
    * Creates a reverse mapping of aliases.
    *
    * @return a map with directive names as keys and lists of aliases as values.
    */
    ...
    */
   public boolean isExcluded(final String directive) {
