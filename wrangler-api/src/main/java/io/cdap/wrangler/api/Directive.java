 ...
 */
 ...
 public interface Directive extends Executor<List<Row>, List<Row>>, EntityMetrics {
    ...
    * {@code TokenType} and {@code optional} field that specifies whether 
    * the token specified is optionally present.</p>
    *
    * <p>The {@code UsageDefinition} provides different methods to 
    * {@code define}, and as well generate {@code usage} based on the 
    * definition.</p>
    *
    * <p>This method is invoked by the framework at the time of creating an 
    * executable directive that will be added to the {@link RecipePipeline}. 
    * It's generally during the configuration phase.</p>.
    *
    * <p>NOTE: As best practice, developer needs to make sure that this class 
    * doesn't throw an exception. Also, it should not include external libraries
    * that can generate exception unknown to the developer.</p>
    *
    * <p>
    ...
    * argument expected by this directive.
    *
    ...
    * each metric to be emitted can be returned and used in the metrics emission 
    * logic elsewhere.
